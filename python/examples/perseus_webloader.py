...
Philo_Types = ["doc","div1","div2","div3","para"] # every object type you'll be indexing.  pages don't count, yet.
...
#            ".//div2":"div",
#            ".//div3":"div",
            ".//milestone[@unit='chapter']":"div2",
            ".//milestone[@unit='section']":"div3",
            ".//p":"para",
            ".//sp":"para",
            #"stage":"para"
            ".//pb":"page",
...
Metadata_XPaths = { # metadata per type.  '.' is in this case the base element for the type, as specified in XPaths above.
             ...
             "div1" : [(ContentExtractor,"./head","head"),
                      (ContentExtractor,"./head//*","head"),
                      (AttributeExtractor,".@n","n"),
                      (AttributeExtractor,".@type","perseus_type"),
                      (AttributeExtractor,".@xml:id","id")],
             "div2" : [(ContentExtractor,"./head","head"),
                      (ContentExtractor,"./head//*","head"),
                      (AttributeExtractor,".@n","n"),
                      (AttributeExtractor,".@unit","perseus_type"),
                      (AttributeExtractor,".@xml:id","id")],
             "div3" : [(ContentExtractor,"./head","head"),
                      (ContentExtractor,"./head//*","head"),
                      (AttributeExtractor,".@n","n"),
                      (AttributeExtractor,".@unit","perseus_type"),
                      (AttributeExtractor,".@xml:id","id")],

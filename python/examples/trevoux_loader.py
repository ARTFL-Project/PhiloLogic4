...
Metadata_XPaths = { # metadata per type.  '.' is in this case the base element for the type, as specified in XPaths above.
             "doc" : [(ContentExtractor,"./teiHeader/fileDesc/sourceDesc/bibl/title", "title"),
                      (ContentExtractor,"./teiHeader/fileDesc/sourceDesc/bibl/imprint/date", "date"),
                      (ContentExtractor,"./teiHeader/fileDesc/sourceDesc/bibl/publisher", "publisher"),
                      (ContentExtractor,"./teiHeader/fileDesc/sourceDesc/bibl/pubPlace", "pub_place"),

(function() {
    ...
    angular
        .module('philoApp')
        .controller('TableOfContentsController', TableOfContentsController)

    function TableOfContentsController($rootScope, $http, $location, $routeParams, accessControl, URL, request) {
        var vm = this;
